             ...
             ?>
                ...
                if(isset($_POST['submit'])){
                    ...
                    $check = mysqli_query($conn, $insert);
                             ...
                             $sql2 = "UPDATE tbl_order SET status = '$status', order_date = '$order_date2', customer_name = '$customer_name', customer_contact ='$customer_contact', customer_address = '$customer_address' WHERE id_table = '$id_tbl' AND status != 'Delivered'";
                            //proses eksekusi
