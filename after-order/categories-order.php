 ...
 <!-- fOOD sEARCH Section Starts Here -->
    <section class="food-search text-center">
        <div class="container">
            ...
            <form action="<?php echo SITEURL;?>after-order/foods-search-order.php?order_id=<?php echo $id;?>" method="POST">
        ...
        <div class="container">
            ...
            if($count>0){
                ...
                while($row = mysqli_fetch_assoc($res)){
                    ...
                    <a href="<?php echo SITEURL;?>after-order/categories-food-order.php?order_id=<?php echo $order_id;?>&category_id=<?php echo $id;?>" data-aos="zoom-in" data-aos-duration="2000">
